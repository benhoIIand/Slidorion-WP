		...
		slidorion: function(options) {
			...
			return this.each(function() {
				...
				function calculateContentHeight() {
					...
					var accordHeight    = $('#accordion', obj).outerHeight(),
						headerHeight    = $('#accordion .link-header:first', obj).outerHeight(),
						contentPaddingT = parseInt($('#accordion .link-content:first', obj).css('paddingTop').replace("px", "")),
						contentPaddingB = parseInt($('#accordion .link-content:first', obj).css('paddingBottom').replace("px", "")),
						contentHeight = accordHeight - (headerHeight * sliderCount),
						newHeight = contentHeight - (contentPaddingT + contentPaddingB);

					$('#accordion > .link-content', obj).css('height', newHeight+'px');
				}
